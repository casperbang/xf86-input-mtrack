...
void mconfig_defaults(struct MConfig* cfg)
{
	...
	cfg->swipe_coast_enable = DEFAULT_SCROLL_COAST_ENABLE;
	cfg->swipe_coast_speed = DEFAULT_SCROLL_COAST_SPEED;
	cfg->swipe_coast_decel = DEFAULT_SCROLL_COAST_DECEL;
	...
	cfg->swipe4_coast_enable = DEFAULT_SCROLL_COAST_ENABLE;
	cfg->swipe4_coast_speed = DEFAULT_SCROLL_COAST_SPEED;
	cfg->swipe4_coast_decel = DEFAULT_SCROLL_COAST_DECEL;
			...
			pointer opts)
{
	...
	cfg->swipe_coast_enable = xf86SetBoolOption(opts, "SwipeCoastEnable", DEFAULT_SWIPE_COAST_ENABLE);
	cfg->swipe_coast_speed = MAXVAL(xf86SetIntOption(opts, "SwipeCoastEnableSpeed", DEFAULT_SWIPE_COAST_SPEED), 0);
	cfg->swipe_coast_decel = MAXVAL(xf86SetIntOption(opts, "SwipeCoastDecelerate", DEFAULT_SWIPE_COAST_DECEL), 0);
	...
	cfg->swipe4_coast_enable = xf86SetBoolOption(opts, "Swipe4CoastEnable", DEFAULT_SWIPE4_COAST_ENABLE);
	cfg->swipe4_coast_speed = MAXVAL(xf86SetIntOption(opts, "Swipe4CoastEnableSpeed", DEFAULT_SWIPE4_COAST_SPEED), 0);
	cfg->swipe4_coast_decel = MAXVAL(xf86SetIntOption(opts, "Swipe4CoastDecelerate", DEFAULT_SWIPE4_COAST_DECEL), 0);
